...
Our solution consists of 2 models. The first model is called StructureClassification that does object localization of the 9 structures in the image. The second model is called SNSClassification that classifies the image as standard or nonstandard.
